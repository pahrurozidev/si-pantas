    ...
    <div class="navbar-nav border-start">
        <div class="nav-item text-nowrap">
            <form action="/logout" method="POST" class="d-inline-block nav-link px-3 text-dark">
                @csrf
                <button type="submit" class="dropdown-item keluar"><i class="bi bi-box-arrow-right"></i><span class="ms-2">Keluar</span></button>
            </form>
        </div>
    </div>
</header>
...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-transparent sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/desa/history">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/warga/history">
                    <i class="bi bi-clock-history"></i> <span class="ms-1">History</span> </a>
            </li>
            @endcan
