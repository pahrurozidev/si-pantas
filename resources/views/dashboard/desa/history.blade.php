...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mb-5">
    ...
    <div class="col-lg-12">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="p-2 col-lg-3 text-center">
                        {{ $penerima->nama }}
                        <a href="/dashboard/desa/history/detail/{{ $penerima->id }}" class="text-decoration-none text-dark d-inline-block text-white badge bg-primary"> <i class="bi bi-eye"></i></a>
                    </td>
                    ...
                    @else
                    <td class="text-center col-lg-2"><span class="badge bg-danger">Belum Tersalurkan</span></td>
                    @endif
        ...
        @else
        <h5 class="mt-5 text-center">Belum Ada Bantuan yang Tersalurkan</h5>
        @endif
    </div>
</main>
@endsection