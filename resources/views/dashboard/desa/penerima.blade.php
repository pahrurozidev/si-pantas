                        ...
                        <tr>
                            ...
                            <td class="p-2 col-lg-3 text-center">
                                ...
                                <a href="/dashboard/desa/penerima/detail/{{ $penerima->id }}"
                                    class="text-decoration-none text-dark d-inline-block text-white badge bg-primary"> <i
                                        class="bi bi-eye"></i></a>
                            </td>
                            ...
                            @else
                                <td class="p-2 col-lg-3 text-center">
                                    <form action="/dashboard/desa/penerima/{{ $penerima->id }}" method="POST">
                                        ...
                                        <button class="btn btn-primary" onclick="return confirm('Apakah anda yakin?')"><i
