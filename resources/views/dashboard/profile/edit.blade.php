    ...
    <div class="col-lg-8">
        ...
        <form action="{{ route('profile.update') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('nama', Auth::user()->nama) }}" type="text" class="form-control" name="nama" id="nama" placeholder="nama">
                @error('nama')
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('username', Auth::user()->username) }}" type="text" class="form-control" name="username" id="username" placeholder="username">
                @error('username')
                <div class="text-danger">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('nik', Auth::user()->nik) }}" type="number" class="form-control" name="nik" id="nik" placeholder="nik">
                @error('nik')
                <div class="text-danger">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('telepon', Auth::user()->telepon) }}" type="number" class="form-control" name="telepon" id="telepon" placeholder="telepon">
                @error('telepon')
                <div class="text-danger">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('email', Auth::user()->email) }}" type="email" class="form-control" name="email" id="email" placeholder="email">
                @error('email')
                <div class="text-danger">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('tgl_lahir', Auth::user()->tgl_lahir) }}" type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" placeholder="tgl_lahir">
                @error('tgl_lahir')
                <div class="text-danger">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select" name="provinsi" id="provinsi">
                        <option value="{{ Auth::user()->provinsi }} {{ ucwords(strtolower(Auth::user()->provinsi)) }}" 
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('rt_rw', Auth::user()->rt_rw) }}" type="text" class="form-control" name="rt_rw" id="rt_rw" placeholder="RT / RW">
                @error('kode_pos')
                <div class="text-danger">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('kode_pos', Auth::user()->kode_pos) }}" type="number" class="form-control" name="kode_pos" id="kode_pos" placeholder="Kode Pos">
                @error('kode_pos')
                <div class="text-danger">
                    {{ $message }}
                </div>
